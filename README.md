...
&nbsp;
[![Portfolio](https://img.shields.io/badge/Portfolio-000000?style=flat-square&logo=vercel&logoColor=white)](https://chandan-b-k.netlify.app)
&nbsp;
...
I build things that grow businesses — from full-stack web apps and AI tools to performance marketing systems. Founder of **AdGrades**, a hybrid marketing + software agency serving startups and SMEs across India.

- 🚀 &nbsp;Building **AdGrades** — AI-led marketing automation + scalable web products
- 💼 &nbsp;Ex **Digital Growth Lead** @ OS Code Solutions (Google, Meta & LinkedIn Ads)
...
|---------|-------------|-------|
| [**adgrades-main**](https://github.com/Chan-electro/adgrades-main) | Official AdGrades website — marketing agency platform | TypeScript |
| [**Blockchain-agri**](https://github.com/Chan-electro/Blockchain-agri) | Blockchain-based supply chain transparency for agriculture | TypeScript |
| [**brain-tumor-ml**](https://github.com/Chan-electro/brain-tumor-ml) | ML model for brain tumor detection and classification | Jupyter/Python |
| [**face-recognition-ai-attendance-system**](https://github.com/Chan-electro/face-recognition-ai-attendance-system) | AI-powered attendance system using facial recognition | HTML/Python |
| [**car-intrusion-detection-system**](https://github.com/Chan-electro/car-intrusion-detection-system) | Vehicle intrusion detection system | HTML |
| [**weather-ai-app**](https://github.com/Chan-electro/weather-ai-app) | AI-enhanced weather application | TypeScript |
| [**Health-Assistant-ProDocs**](https://github.com/Chan-electro/Health-Assistant-ProDocs) | IoT smart healthcare assistant — Raspberry Pi, Flask, real-time vitals monitoring | Python/ML |
| [**agreement-invoice-generator**](https://github.com/Chan-electro/agreement-invoice-generator) | Automated agreement and invoice generation tool | TypeScript |
| [**Offline-Map-routing**](https://github.com/Chan-electro/Offline-Map-routing) | Offline-capable map routing system | TypeScript |
| [**brahma-kalasha**](https://github.com/Chan-electro/brahma-kalasha) | Official display website for Brahma Kalasha | TypeScript |
...
- 🎨 Figma UI/UX Design Essentials & Advanced — Udemy
- 🌐 The Complete Full-Stack Web Development — Udemy
- 🐍 100 Days of Code: The Complete Python — Udemy
